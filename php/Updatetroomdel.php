...
if ($myFormAction == "3") {
    ...
    $mySQL = "DELETE FROM troom WHERE  troom.CountryID = '" . $ID1 . "'" . " AND troom.BranchID = '" . $ID2 . "'" . " AND troom.ID = " . $ID3;
...
if (!$myFormAction == "3"):
    ...
    if(getSession("BrowseRoom#WHR") != ""):
        $ClarionData .= "<a href=BrowseRoom" . "list.php?SUBSET=TRUE>Return to list</a>\n";
    else:
