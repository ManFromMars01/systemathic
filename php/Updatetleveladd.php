...
function MergeAddTemplate($Template) {
    ...
    if(!isset($Template) || ($Template =="")):
        $Template =  "./html/Updatetleveladd.htm";
    endif;
...
$UpdatetlevelFormAction = "Updatetleveladdx.php";
$tlevelCountryID  = getRequest("txttlevelCountryID");
$tlevelBranchID  = getRequest("txttlevelBranchID");
$tlevelID  = getRequest("txttlevelID");
$tlevelDescription  = getRequest("txttlevelDescription");

if ($_SESSION["Updatetlevel_InsertFailed"] == 1) {
   $tlevelCountryID = $_SESSION["SavedtlevelCountryID"];
   $tlevelBranchID = $_SESSION["SavedtlevelBranchID"];
   $tlevelID = $_SESSION["SavedtlevelID"];
   $tlevelDescription = $_SESSION["SavedtlevelDescription"];
}
