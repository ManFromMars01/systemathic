...
if ($myFormAction == "3") {
    ...
    $mySQL = "DELETE FROM tprogress2 WHERE  tprogress2.CountryID = '" . $ID1 . "'" . " AND tprogress2.BranchID = '" . $ID2 . "'" . " AND tprogress2.Level1ID = '" . $ID3 . "'" . " AND tprogress2.Level2ID = '" . $ID4 . "'";
...
if (!$myFormAction == "3"):
    ...
    if(getSession("BrowseTProgress2#WHR") != ""):
        $ClarionData .= "<a href=BrowseTProgress2" . "list.php?SUBSET=TRUE>Return to list</a>\n";
    else:
