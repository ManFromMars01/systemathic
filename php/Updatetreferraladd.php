...
function MergeAddTemplate($Template) {
    ...
    if(!isset($Template) || ($Template =="")):
        $Template =  "./html/Updatetreferraladd.htm";
    endif;
...
$UpdatetreferralFormAction = "Updatetreferraladdx.php";
$treferralCountryID  = getRequest("txttreferralCountryID");
$treferralBranchID  = getRequest("txttreferralBranchID");
$treferralID  = getRequest("txttreferralID");
$treferralDescription  = getRequest("txttreferralDescription");

if ($_SESSION["Updatetreferral_InsertFailed"] == 1) {
   $treferralCountryID = $_SESSION["SavedtreferralCountryID"];
   $treferralBranchID = $_SESSION["SavedtreferralBranchID"];
   $treferralID = $_SESSION["SavedtreferralID"];
   $treferralDescription = $_SESSION["SavedtreferralDescription"];
}
