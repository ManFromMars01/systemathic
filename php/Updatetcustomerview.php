...
$ID2 = "";
$ID3 = "";
$UpdatetcustomerFormAction = "Updatetcustomer" . "edit.php";
$tcustomerCountryID = "";
$tcustomerBranchID = "";
$tcustomerCustNo = "";
$tcustomerStudentID = "";
...
function  MergeUpdatetcustomerTemplate($Template){
    if(!isset($Template) || ($Template =="")):
        $Template = "./html/Updatetcustomer" . "view.htm";
    endif;
...
$dbNavBarPrev = "";
$dbNavBarNext = "";
$dbNavBarPrev = "<a href=Updatetcustomer" . "view.php?";
$dbNavBarNext = "<a href=Updatetcustomer" . "view.php?";
...
$oRStcustomer->Close();
MergeUpdatetcustomerTemplate($HTML_Template);
unset($oRStcustomer);
    $objConn1->Close();
    unset($objConn1);
?>
