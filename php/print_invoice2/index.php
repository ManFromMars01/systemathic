...
$branch = $model->select_where('tbranch', array('BranchID' => $_SESSION['UserValue2']));
$ehroyalty = $model->select_where('ehroyalty', array('BranchID' => $_SESSION['UserValue2'], 'Status' => '5' ));
?>
...
<body>
	...
	<div id="page-wrap">
		...
		<div id="identity">
            ...
            <textarea id="address">
<?php echo $branch->fields['Address1'];?>

Phone: <?php echo $branch->fields['Phone'];?></textarea>
		...
		<div id="customer">
            ...
            <textarea id="customer-title"><?php echo $branch->fields['Contact']; ?></textarea>

            <table id="meta">
                <tr>
                    <td class="meta-head">Invoice #</td>
                    <td><textarea>000123a</textarea></td>
                </tr>
                <tr>
		...
		<table id="items">
		  ...
		  <?php foreach($ehroyalty as $mydetails): ?>
		  <tr class="item-row">
