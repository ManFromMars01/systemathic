...
oCMenu.makeMenu('Browsetbranch','FileMenu','Centers List','Browsetbranchlist.php');
oCMenu.makeMenu('ITEM3','FileMenu','Department List','BrowseDeptlist.php');
oCMenu.makeMenu('ITEM2','FileMenu','Accounts List','');
oCMenu.makeMenu('ITEM4','FileMenu','Bank List','');
oCMenu.makeMenu('ITEM6','FileMenu','Category List','BrowseCategorylist.php');
oCMenu.makeMenu('ITEM7','FileMenu','Sub-Category List','BrowseSubCateglist.php');
...
oCMenu.makeMenu('ITEM14','FileMenu','Class Schedule List','BrowseSchedListlist.php');
oCMenu.makeMenu('ITEM15','FileMenu','Attendance Status List','BrowseAttendanceStatuslist.php');
oCMenu.makeMenu('ITEM16','FileMenu','Progress List','');
...
oCMenu.makeMenu('ITEM19','FileMenu','Payment Type List','');
...
oCMenu.makeMenu('ITEM29','MENU1','Create Schedule','');
