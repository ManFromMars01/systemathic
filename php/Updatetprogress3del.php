...
if ($myFormAction == "3") {
    ...
    $mySQL = "DELETE FROM tprogress3 WHERE  tprogress3.CountryID = '" . $ID1 . "'" . " AND tprogress3.BranchID = '" . $ID2 . "'" . " AND tprogress3.Level1ID = '" . $ID3 . "'" . " AND tprogress3.Level2ID = '" . $ID4 . "'" . " AND tprogress3.Level3ID = '" . $ID5 . "'";
...
if (!$myFormAction == "3"):
    ...
    if(getSession("BrowseTProgress3#WHR") != ""):
        $ClarionData .= "<a href=BrowseTProgress3" . "list.php?SUBSET=TRUE>Return to list</a>\n";
    else:
