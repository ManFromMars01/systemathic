...
function MergeAddTemplate($Template) {
    ...
    if(!isset($Template) || ($Template =="")):
        $Template =  "./html/Updatetlocationadd.htm";
    endif;
...
$UpdatetlocationFormAction = "Updatetlocationaddx.php";
$tlocationCountryID  = getRequest("txttlocationCountryID");
$tlocationBranchID  = getRequest("txttlocationBranchID");
$tlocationID  = getRequest("txttlocationID");
$tlocationDescription  = getRequest("txttlocationDescription");

if ($_SESSION["Updatetlocation_InsertFailed"] == 1) {
   $tlocationCountryID = $_SESSION["SavedtlocationCountryID"];
   $tlocationBranchID = $_SESSION["SavedtlocationBranchID"];
   $tlocationID = $_SESSION["SavedtlocationID"];
   $tlocationDescription = $_SESSION["SavedtlocationDescription"];
}
