...
$DeleteButton = "";
$UpdatetassessmentFormAction = "";
//============================================================================='
// MergeTemplate 
//============================================================================='
function MergeTemplate($Template) {
    if(!isset($Template) || ($Template =="")):
        $Template = "./html/Updatetassessment" . "edit.htm";
    endif;
    global $DeleteButton;   
    global $Header;   
    global $Footer;   
...
$UpdatetassessmentFormAction = "Updatetassessmenteditx.php";
$oRStassessmentCountryID = $oRStassessment->fields["CountryID"];
$oRStassessmentBranchID = $oRStassessment->fields["BranchID"];
$oRStassessmentID = $oRStassessment->fields["ID"];
...
$tassessmentCountryID = trim(getValue($oRStassessment->fields["CountryID"]));
endif;
$tassessmentBranchID = "";
if (is_null($oRStassessment->fields["BranchID"])):
$tassessmentBranchID = "";
else:
$tassessmentBranchID = trim(getValue($oRStassessment->fields["BranchID"]));
endif;
$tassessmentID = "";
...
$DeleteButton = "<form method='post' action='Updatetassessmentdel.php' id='form1' name='form1'>";
...
if ($_SESSION["Updatetassessment_EditFailed"] == 1) {
  $tassessmentCountryID = $_SESSION["SavedEdittassessmentCountryID"];
  $tassessmentBranchID = $_SESSION["SavedEdittassessmentBranchID"];
  $tassessmentID = $_SESSION["SavedEdittassessmentID"];
  $tassessmentDescription = $_SESSION["SavedEdittassessmentDescription"];
}
else {
