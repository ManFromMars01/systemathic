...
if (getRequest("RESETLIST") != ""):
    $myWhere = "";
    $_SESSION["BrowseBookList#WHR"] = "";
    $_SESSION["BrowseBookList#COL"] = "";
    $_SESSION["BrowseBookList#SRT"] = "";
    $_SESSION["BrowseBookList#PreviousColumn"] = "";
    $_SESSION["BrowseBookList#PreviousSort"] = "";
    $_SESSION["BrowseBookList#mySort"] = "";
    $_SESSION["BrowseBookList#myOrder"] = "";    
endif;
...
if (getRequest("COL") == ""):
    ...
    $_SESSION["BrowseBookList#PreviousColumn"] = getRequest("COL");
endif;

if (getRequest("SRT") == ""):
    $_SESSION["BrowseBookList#PreviousSort"] = "";
else:
    $_SESSION["BrowseBookList#PreviousSort"] = getRequest("SRT");
endif;

if (getSession("BrowseBookList#COL") == ""):
    if (getRequest("COL") . getSession("BrowseBookList#COL") == ""):
        $_SESSION["BrowseBookList#COL"] = "CountryID";
    endif;
endif;

if (getRequest("COL") == "CountryID"):
    if (getRequest("SRT") == "DESC"):
        $_SESSION["BrowseBookList#myOrder"] = "ORDER BY tcustomer.CountryID DESC";
        $_SESSION["BrowseBookList#mySort"] = "DESC";
    else:
        $_SESSION["BrowseBookList#myOrder"] = "ORDER BY tcustomer.CountryID ASC";
        $_SESSION["BrowseBookList#mySort"] = "ASC";
    endif;
    if (getRequest("COL") != getSession("BrowseBookList#PreviousColumn")):
        $_SESSION["BrowseBookList#myOrder"] = "ORDER BY tcustomer.CountryID ASC";
        $_SESSION["BrowseBookList#mySort"] = "ASC";
    endif;
    $_SESSION["BrowseBookList#COL"] = "CountryID";
    $_SESSION["BrowseBookList#SRT"] = getSession("BrowseBookList#mySort");
endif;

if (getRequest("COL") == "BranchID"):
    if (getRequest("SRT") == "DESC"):
        $_SESSION["BrowseBookList#myOrder"] = "ORDER BY tcustomer.BranchID DESC";
        $_SESSION["BrowseBookList#mySort"] = "DESC";
    else:
        $_SESSION["BrowseBookList#myOrder"] = "ORDER BY tcustomer.BranchID ASC";
        $_SESSION["BrowseBookList#mySort"] = "ASC";
    endif;
    if (getRequest("COL") != getSession("BrowseBookList#PreviousColumn")):
        $_SESSION["BrowseBookList#myOrder"] = "ORDER BY tcustomer.BranchID ASC";
    ...
    $_SESSION["BrowseBookList#COL"] = "BranchID";
    $_SESSION["BrowseBookList#SRT"] = getSession("BrowseBookList#mySort");
endif;

if (getRequest("COL") == "CustNo"):
    if (getRequest("SRT") == "DESC"):
        $_SESSION["BrowseBookList#myOrder"] = "ORDER BY tcustomer.CustNo DESC";
        $_SESSION["BrowseBookList#mySort"] = "DESC";
    else:
        $_SESSION["BrowseBookList#myOrder"] = "ORDER BY tcustomer.CustNo ASC";
        $_SESSION["BrowseBookList#mySort"] = "ASC";
    endif;
    if (getRequest("COL") != getSession("BrowseBookList#PreviousColumn")):
        $_SESSION["BrowseBookList#myOrder"] = "ORDER BY tcustomer.CustNo ASC";
    ...
    $_SESSION["BrowseBookList#COL"] = "CustNo";
    $_SESSION["BrowseBookList#SRT"] = getSession("BrowseBookList#mySort");
endif;

if (getRequest("COL") == "StudentID"):
    if (getRequest("SRT") == "DESC"):
        $_SESSION["BrowseBookList#myOrder"] = "ORDER BY tcustomer.StudentID DESC";
        $_SESSION["BrowseBookList#mySort"] = "DESC";
    else:
        $_SESSION["BrowseBookList#myOrder"] = "ORDER BY tcustomer.StudentID ASC";
        $_SESSION["BrowseBookList#mySort"] = "ASC";
    endif;
    if (getRequest("COL") != getSession("BrowseBookList#PreviousColumn")):
        $_SESSION["BrowseBookList#myOrder"] = "ORDER BY tcustomer.StudentID ASC";
    ...
    $_SESSION["BrowseBookList#COL"] = "StudentID";
    $_SESSION["BrowseBookList#SRT"] = getSession("BrowseBookList#mySort");
endif;

if (getRequest("COL") == "SurName"):
    if (getRequest("SRT") == "DESC"):
        $_SESSION["BrowseBookList#myOrder"] = "ORDER BY tcustomer.SurName DESC";
        $_SESSION["BrowseBookList#mySort"] = "DESC";
    else:
        $_SESSION["BrowseBookList#myOrder"] = "ORDER BY tcustomer.SurName ASC";
        $_SESSION["BrowseBookList#mySort"] = "ASC";
    endif;
    if (getRequest("COL") != getSession("BrowseBookList#PreviousColumn")):
        $_SESSION["BrowseBookList#myOrder"] = "ORDER BY tcustomer.SurName ASC";
    ...
    $_SESSION["BrowseBookList#COL"] = "SurName";
    $_SESSION["BrowseBookList#SRT"] = getSession("BrowseBookList#mySort");
endif;

if (getRequest("COL") == "FirstName"):
    if (getRequest("SRT") == "DESC"):
        $_SESSION["BrowseBookList#myOrder"] = "ORDER BY tcustomer.FirstName DESC";
        $_SESSION["BrowseBookList#mySort"] = "DESC";
    else:
        $_SESSION["BrowseBookList#myOrder"] = "ORDER BY tcustomer.FirstName ASC";
        $_SESSION["BrowseBookList#mySort"] = "ASC";
    endif;
    if (getRequest("COL") != getSession("BrowseBookList#PreviousColumn")):
        $_SESSION["BrowseBookList#myOrder"] = "ORDER BY tcustomer.FirstName ASC";
    ...
    $_SESSION["BrowseBookList#COL"] = "FirstName";
    $_SESSION["BrowseBookList#SRT"] = getSession("BrowseBookList#mySort");
endif;

if (getRequest("COL") == "MiddleName"):
    if (getRequest("SRT") == "DESC"):
        $_SESSION["BrowseBookList#myOrder"] = "ORDER BY tcustomer.MiddleName DESC";
        $_SESSION["BrowseBookList#mySort"] = "DESC";
    else:
        $_SESSION["BrowseBookList#myOrder"] = "ORDER BY tcustomer.MiddleName ASC";
        $_SESSION["BrowseBookList#mySort"] = "ASC";
    endif;
    if (getRequest("COL") != getSession("BrowseBookList#PreviousColumn")):
        $_SESSION["BrowseBookList#myOrder"] = "ORDER BY tcustomer.MiddleName ASC";
    ...
    $_SESSION["BrowseBookList#COL"] = "MiddleName";
    $_SESSION["BrowseBookList#SRT"] = getSession("BrowseBookList#mySort");
endif;

if (getRequest("COL") == "LSurname"):
    if (getRequest("SRT") == "DESC"):
        $_SESSION["BrowseBookList#myOrder"] = "ORDER BY tcustomer.LSurname DESC";
        $_SESSION["BrowseBookList#mySort"] = "DESC";
    else:
        $_SESSION["BrowseBookList#myOrder"] = "ORDER BY tcustomer.LSurname ASC";
        $_SESSION["BrowseBookList#mySort"] = "ASC";
    endif;
    if (getRequest("COL") != getSession("BrowseBookList#PreviousColumn")):
        $_SESSION["BrowseBookList#myOrder"] = "ORDER BY tcustomer.LSurname ASC";
    ...
    $_SESSION["BrowseBookList#COL"] = "LSurname";
    $_SESSION["BrowseBookList#SRT"] = getSession("BrowseBookList#mySort");
endif;

if (getRequest("COL") == "LFirstName"):
    if (getRequest("SRT") == "DESC"):
        $_SESSION["BrowseBookList#myOrder"] = "ORDER BY tcustomer.LFirstName DESC";
        $_SESSION["BrowseBookList#mySort"] = "DESC";
    else:
        $_SESSION["BrowseBookList#myOrder"] = "ORDER BY tcustomer.LFirstName ASC";
        $_SESSION["BrowseBookList#mySort"] = "ASC";
    endif;
    if (getRequest("COL") != getSession("BrowseBookList#PreviousColumn")):
        $_SESSION["BrowseBookList#myOrder"] = "ORDER BY tcustomer.LFirstName ASC";
    ...
    $_SESSION["BrowseBookList#COL"] = "LFirstName";
    $_SESSION["BrowseBookList#SRT"] = getSession("BrowseBookList#mySort");
endif;
...
if ( getRequest("WHR") != ""):
    ...
    $_SESSION["BrowseBookList#WHR"] =  getRequest("WHR");
elseif (getSession("BrowseBookList#WHR") != ""):
    $myWhere    = getSession("BrowseBookList#WHR");
endif;
...
if ($myWhere == ""):
    if (getRequest("LOCATE") == "TRUE"):
      ...
      $_SESSION["BrowseBookList#WHR"] = $myWhere;
    endif;
else:
    if(getRequest("LOCATE") == "TRUE"):
        $myWhere .= " AND ";
...
if (getSession("BrowseBookList#myOrder") == ""):
    $_SESSION["BrowseBookList#myOrder"] = "ORDER BY tcustomer.CountryID ASC";
    $_SESSION["BrowseBookList#mySort"] = "ASC";
    $_SESSION["BrowseBookList#COL"] = "CountryID";
    $_SESSION["BrowseBookList#SRT"] = getSession("BrowseBookList#mySort");
...
if (getSession("BrowseBookList#myOrder") !=""):
    $mySQL .= " " . getSession("BrowseBookList#myOrder");
endif;
...
if ($oRStcustomer):
    if($oRStcustomer->EOF != TRUE):
        if($oRStcustomer->RecordCount() > 0):
            $oRStcustomer->Move(0);         
            if(getRequest("LOCATE") == "TRUE"):
                $SearchMessage =  "<A href=BrowseBookList" . "list.php?RESETLIST=TRUE>All data</A>";
            endif;
            MergeBrowseBookListListTemplate($HTML_Template);
        else:
            NoRecordsFound();
        endif;
    else:
...
function NoRecordsFound() {
    ...
    fclose ($FileObject);
    $tmpMsg = "";
    $tmpMsg = "<a href='BrowseBookList" . "list.php?RESETLIST=TRUE'>No records were found</a>";
...
/*
=============================================================================
  MergeBrowseBookListListTemplate($Template)
=============================================================================
*/
function MergeBrowseBookListListTemplate($Template) {
    global $ClarionData;
    global $SearchField;
    ...
    global $userdata1;
    if($Template == ""):
        $Template = "./html/BrowseBookListlist.htm";
    endif;      
    $FileObject = fopen($Template, "r");
    $TemplateText = "";
    $TemplateText = fread($FileObject, filesize($Template));
...
function buildColumnLabels() {
    ...
    $myLink = "";
        $myLink = "<a href=\"" . $myPage . "?";
            ...
            if ( getSession("BrowseBookList#PreviousColumn") == "CountryID"):
                if (getSession("BrowseBookList#SRT") == "ASC"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                endif;
            else:
                if (getSession("BrowseBookList#COL") == "CountryID"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                endif;
        ...
        if ( getGet("COL") == "CountryID" || getSession("BrowseBookList#COL") == "CountryID" ):
            if (getSession("BrowseBookList#SRT") == "ASC"):
        ...
        $myLink = "<a href=\"" . $myPage . "?";
            $myLink .= "COL=BranchID";
            if ( getSession("BrowseBookList#PreviousColumn") == "BranchID"):
                if (getSession("BrowseBookList#SRT") == "ASC"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                ...
                if (getSession("BrowseBookList#COL") == "BranchID"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                endif;
        ...
        if ( getGet("COL") == "BranchID" || getSession("BrowseBookList#COL") == "BranchID" ):
            if (getSession("BrowseBookList#SRT") == "ASC"):
        ...
        $myLink = "<a href=\"" . $myPage . "?";
            $myLink .= "COL=CustNo";
            if ( getSession("BrowseBookList#PreviousColumn") == "CustNo"):
                if (getSession("BrowseBookList#SRT") == "ASC"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                ...
                if (getSession("BrowseBookList#COL") == "CustNo"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                endif;
            ...
            $myLink .= "\">Cust No</a>";
        $CustNoLABEL = $myLink;
        if ( getGet("COL") == "CustNo" || getSession("BrowseBookList#COL") == "CustNo" ):
            if (getSession("BrowseBookList#SRT") == "ASC"):
        ...
        $myLink = "<a href=\"" . $myPage . "?";
            ...
            if ( getSession("BrowseBookList#PreviousColumn") == "StudentID"):
                if (getSession("BrowseBookList#SRT") == "ASC"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                ...
                if (getSession("BrowseBookList#COL") == "StudentID"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                endif;
        ...
        if ( getGet("COL") == "StudentID" || getSession("BrowseBookList#COL") == "StudentID" ):
            if (getSession("BrowseBookList#SRT") == "ASC"):
        ...
        $myLink = "<a href=\"" . $myPage . "?";
            $myLink .= "COL=SurName";
            if ( getSession("BrowseBookList#PreviousColumn") == "SurName"):
                if (getSession("BrowseBookList#SRT") == "ASC"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                ...
                if (getSession("BrowseBookList#COL") == "SurName"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                endif;
            ...
            $myLink .= "\">Sur Name</a>";
        $SurNameLABEL = $myLink;
        if ( getGet("COL") == "SurName" || getSession("BrowseBookList#COL") == "SurName" ):
            if (getSession("BrowseBookList#SRT") == "ASC"):
        ...
        $myLink = "<a href=\"" . $myPage . "?";
            ...
            if ( getSession("BrowseBookList#PreviousColumn") == "FirstName"):
                if (getSession("BrowseBookList#SRT") == "ASC"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                ...
                if (getSession("BrowseBookList#COL") == "FirstName"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                endif;
        ...
        if ( getGet("COL") == "FirstName" || getSession("BrowseBookList#COL") == "FirstName" ):
            if (getSession("BrowseBookList#SRT") == "ASC"):
        ...
        $myLink = "<a href=\"" . $myPage . "?";
            ...
            if ( getSession("BrowseBookList#PreviousColumn") == "MiddleName"):
                if (getSession("BrowseBookList#SRT") == "ASC"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                ...
                if (getSession("BrowseBookList#COL") == "MiddleName"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                endif;
        ...
        if ( getGet("COL") == "MiddleName" || getSession("BrowseBookList#COL") == "MiddleName" ):
            if (getSession("BrowseBookList#SRT") == "ASC"):
        ...
        $myLink = "<a href=\"" . $myPage . "?";
            $myLink .= "COL=LSurname";
            if ( getSession("BrowseBookList#PreviousColumn") == "LSurname"):
                if (getSession("BrowseBookList#SRT") == "ASC"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                ...
                if (getSession("BrowseBookList#COL") == "LSurname"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                endif;
        ...
        if ( getGet("COL") == "LSurname" || getSession("BrowseBookList#COL") == "LSurname" ):
            if (getSession("BrowseBookList#SRT") == "ASC"):
        ...
        $myLink = "<a href=\"" . $myPage . "?";
            ...
            if ( getSession("BrowseBookList#PreviousColumn") == "LFirstName"):
                if (getSession("BrowseBookList#SRT") == "ASC"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                ...
                if (getSession("BrowseBookList#COL") == "LFirstName"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                endif;
        ...
        if ( getGet("COL") == "LFirstName" || getSession("BrowseBookList#COL") == "LFirstName" ):
            if (getSession("BrowseBookList#SRT") == "ASC"):
...
$Seq = 0;
    ...
    $myLink = "";
            $myLink = "<a href=\"BrowseBookslist.php?ID1=";
            ...
            $tmpIMG_tcustomerAutomaticDetailLink = "<img src=\"/images/editpencil.gif\" border=\"0\" alt=\"Book List\">";
