...
$objConn1->PConnect($Server1,$User1,$Password1,$db1);
   ...
   if(isset($_POST['sched_codes'])){
      ...
      $session_number1 = $session_number[0];
      $session_number2 = $session_number[1];
      $session_number3 = $session_number[2];
      $session_number4 = $session_number[3];
      $session_number5 = $session_number[4];
      $session_number6 = $session_number[5];
      $session_number7 = $session_number[6];
