...
// $RecordsPerPage = ##;
$myRecordCount2 = "SELECT COUNT(*) AS MyCount FROM tunitmeas  WHERE tunitmeas.CountryID ='".$_SESSION['UserValue1']."' AND tunitmeas.BranchID = '".$_SESSION['UserValue2']."' ORDER BY tunitmeas.CountryID ASC";
...
$strMyQuote = getQuote($objConn1,"tunitmeas", "tunitmeas.CountryID");
if ($myWhere != ""):
    $myWhere .= " AND ";
endif;
$myWhere .= "tunitmeas.CountryID = " . $strMyQuote . getSession("UserValue1") . $strMyQuote;
$_SESSION["BrowseUnitMeas#WHR"] = $myWhere;
$mySQL = $myQuery;
