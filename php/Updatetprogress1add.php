...
function MergeAddTemplate($Template) {
    ...
    if(!isset($Template) || ($Template =="")):
        $Template =  "./html/Updatetprogress1add.htm";
    endif;
...
$Updatetprogress1FormAction = "Updatetprogress1addx.php";
$tprogress1CountryID  = getRequest("txttprogress1CountryID");
$tprogress1BranchID  = getRequest("txttprogress1BranchID");
$tprogress1Level1ID  = getRequest("txttprogress1Level1ID");
$tprogress1Description  = getRequest("txttprogress1Description");

if ($_SESSION["Updatetprogress1_InsertFailed"] == 1) {
   $tprogress1CountryID = $_SESSION["Savedtprogress1CountryID"];
   $tprogress1BranchID = $_SESSION["Savedtprogress1BranchID"];
   $tprogress1Level1ID = $_SESSION["Savedtprogress1Level1ID"];
   $tprogress1Description = $_SESSION["Savedtprogress1Description"];
}
