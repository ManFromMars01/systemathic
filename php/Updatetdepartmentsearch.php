...
if (getRequest("txttdepartmentCountryID") == ""):
    ...
    $myWhere .= " tdepartment.CountryID LIKE " . chr(39) . getRequest("txttdepartmentCountryID") . "%" . chr(39);
endif;
...
if (getRequest("txttdepartmentBranchID") == ""):
    ...
    $myWhere .= " tdepartment.BranchID LIKE " . chr(39) . getRequest("txttdepartmentBranchID") . "%" . chr(39);
endif;
...
if (getRequest("txttdepartmentID") == ""):
    ...
    $myWhere .= " tdepartment.ID = " . getRequest("txttdepartmentID");
endif;
...
if (getRequest("txttdepartmentDescription") == ""):
    ...
    $myWhere .= " tdepartment.Description LIKE " . chr(39) . getRequest("txttdepartmentDescription") . "%" . chr(39);
endif;
...
function MergeSearchTemplate($Template) {
    ...
    if(!isset($Template) || ($Template =="")):
        $Template = "./html/Updatetdepartment" . "search.htm";
    endif;
...
$DisplayText = "";
if (getRequest("SEARCH") == "TRUE"):
$FormDeclaration = "<form name=\"form1\" id=\"form1\" method=\"POST\" action=\"BrowseDeptlist.php\">";
else:
$FormDeclaration = "<form name=\"form1\" id=\"form1\" method=\"POST\" action=\""; 
$FormDeclaration .=  "Updatetdepartment" . "search.php". "\">" . "\n<input type=\"HIDDEN\" id=\"SEARCH\" name=\"SEARCH\" value=\"TRUE\">";
endif;
