...
$DeleteButton = "";
$UpdatetreferralFormAction = "";
//============================================================================='
// MergeTemplate 
//============================================================================='
function MergeTemplate($Template) {
    if(!isset($Template) || ($Template =="")):
        $Template = "./html/Updatetreferral" . "edit.htm";
    endif;
    global $DeleteButton;   
    global $Header;   
    global $Footer;   
...
$UpdatetreferralFormAction = "Updatetreferraleditx.php";
$oRStreferralCountryID = $oRStreferral->fields["CountryID"];
$oRStreferralBranchID = $oRStreferral->fields["BranchID"];
$oRStreferralID = $oRStreferral->fields["ID"];
...
$treferralCountryID = trim(getValue($oRStreferral->fields["CountryID"]));
endif;
$treferralBranchID = "";
if (is_null($oRStreferral->fields["BranchID"])):
$treferralBranchID = "";
else:
$treferralBranchID = trim(getValue($oRStreferral->fields["BranchID"]));
endif;
$treferralID = "";
...
$treferralDescription = trim(getValue($oRStreferral->fields["Description"]));
endif;
$DeleteLevel = 1;
if (isset($DeleteLevel) && getSession("UserLevel") >= $DeleteLevel):
$DeleteButton = "<form method='post' action='Updatetreferraldel.php' id='form1' name='form1'>";
...
if ($_SESSION["Updatetreferral_EditFailed"] == 1) {
  $treferralCountryID = $_SESSION["SavedEdittreferralCountryID"];
  $treferralBranchID = $_SESSION["SavedEdittreferralBranchID"];
  $treferralID = $_SESSION["SavedEdittreferralID"];
  $treferralDescription = $_SESSION["SavedEdittreferralDescription"];
}
else {
