...
if ($myFormAction == "3") {
    ...
    $mySQL = "DELETE FROM tdrole WHERE  tdrole.CountryID = '" . $ID1 . "'" . " AND tdrole.BranchID = '" . $ID2 . "'" . " AND tdrole.RoleID = '" . $ID3 . "'" . " AND tdrole.PageName = '" . $ID4 . "'";
...
if (!$myFormAction == "3"):
    ...
    if(getSession("BrowseTDRole#WHR") != ""):
        $ClarionData .= "<a href=BrowseTDRole" . "list.php?SUBSET=TRUE>Return to list</a>\n";
    else:
