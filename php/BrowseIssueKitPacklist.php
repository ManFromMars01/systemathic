...
if (getRequest("RESETLIST") != ""):
    $myWhere = "";
    $_SESSION["BrowseIssueKitPack#WHR"] = "";
    $_SESSION["BrowseIssueKitPack#COL"] = "";
    $_SESSION["BrowseIssueKitPack#SRT"] = "";
    $_SESSION["BrowseIssueKitPack#PreviousColumn"] = "";
    $_SESSION["BrowseIssueKitPack#PreviousSort"] = "";
    $_SESSION["BrowseIssueKitPack#mySort"] = "";
    $_SESSION["BrowseIssueKitPack#myOrder"] = "";    
endif;
...
if (getRequest("COL") == ""):
    ...
    $_SESSION["BrowseIssueKitPack#PreviousColumn"] = getRequest("COL");
endif;

if (getRequest("SRT") == ""):
    $_SESSION["BrowseIssueKitPack#PreviousSort"] = "";
else:
    $_SESSION["BrowseIssueKitPack#PreviousSort"] = getRequest("SRT");
endif;

if (getSession("BrowseIssueKitPack#COL") == ""):
    if (getRequest("COL") . getSession("BrowseIssueKitPack#COL") == ""):
        $_SESSION["BrowseIssueKitPack#COL"] = "CountryID";
    endif;
endif;

if (getRequest("COL") == "CountryID"):
    if (getRequest("SRT") == "DESC"):
        $_SESSION["BrowseIssueKitPack#myOrder"] = "ORDER BY tcustomer.CountryID DESC";
        $_SESSION["BrowseIssueKitPack#mySort"] = "DESC";
    else:
        $_SESSION["BrowseIssueKitPack#myOrder"] = "ORDER BY tcustomer.CountryID ASC";
        $_SESSION["BrowseIssueKitPack#mySort"] = "ASC";
    endif;
    if (getRequest("COL") != getSession("BrowseIssueKitPack#PreviousColumn")):
        $_SESSION["BrowseIssueKitPack#myOrder"] = "ORDER BY tcustomer.CountryID ASC";
        $_SESSION["BrowseIssueKitPack#mySort"] = "ASC";
    endif;
    $_SESSION["BrowseIssueKitPack#COL"] = "CountryID";
    $_SESSION["BrowseIssueKitPack#SRT"] = getSession("BrowseIssueKitPack#mySort");
endif;

if (getRequest("COL") == "BranchID"):
    if (getRequest("SRT") == "DESC"):
        $_SESSION["BrowseIssueKitPack#myOrder"] = "ORDER BY tcustomer.BranchID DESC";
        $_SESSION["BrowseIssueKitPack#mySort"] = "DESC";
    else:
        $_SESSION["BrowseIssueKitPack#myOrder"] = "ORDER BY tcustomer.BranchID ASC";
        $_SESSION["BrowseIssueKitPack#mySort"] = "ASC";
    endif;
    if (getRequest("COL") != getSession("BrowseIssueKitPack#PreviousColumn")):
        $_SESSION["BrowseIssueKitPack#myOrder"] = "ORDER BY tcustomer.BranchID ASC";
    ...
    $_SESSION["BrowseIssueKitPack#COL"] = "BranchID";
    $_SESSION["BrowseIssueKitPack#SRT"] = getSession("BrowseIssueKitPack#mySort");
endif;

if (getRequest("COL") == "CustNo"):
    if (getRequest("SRT") == "DESC"):
        $_SESSION["BrowseIssueKitPack#myOrder"] = "ORDER BY tcustomer.CustNo DESC";
        $_SESSION["BrowseIssueKitPack#mySort"] = "DESC";
    else:
        $_SESSION["BrowseIssueKitPack#myOrder"] = "ORDER BY tcustomer.CustNo ASC";
        $_SESSION["BrowseIssueKitPack#mySort"] = "ASC";
    endif;
    if (getRequest("COL") != getSession("BrowseIssueKitPack#PreviousColumn")):
        $_SESSION["BrowseIssueKitPack#myOrder"] = "ORDER BY tcustomer.CustNo ASC";
    ...
    $_SESSION["BrowseIssueKitPack#COL"] = "CustNo";
    $_SESSION["BrowseIssueKitPack#SRT"] = getSession("BrowseIssueKitPack#mySort");
endif;

if (getRequest("COL") == "StudentID"):
    if (getRequest("SRT") == "DESC"):
        $_SESSION["BrowseIssueKitPack#myOrder"] = "ORDER BY tcustomer.StudentID DESC";
        $_SESSION["BrowseIssueKitPack#mySort"] = "DESC";
    else:
        $_SESSION["BrowseIssueKitPack#myOrder"] = "ORDER BY tcustomer.StudentID ASC";
        $_SESSION["BrowseIssueKitPack#mySort"] = "ASC";
    endif;
    if (getRequest("COL") != getSession("BrowseIssueKitPack#PreviousColumn")):
        $_SESSION["BrowseIssueKitPack#myOrder"] = "ORDER BY tcustomer.StudentID ASC";
    ...
    $_SESSION["BrowseIssueKitPack#COL"] = "StudentID";
    $_SESSION["BrowseIssueKitPack#SRT"] = getSession("BrowseIssueKitPack#mySort");
endif;

if (getRequest("COL") == "SurName"):
    if (getRequest("SRT") == "DESC"):
        $_SESSION["BrowseIssueKitPack#myOrder"] = "ORDER BY tcustomer.SurName DESC";
        $_SESSION["BrowseIssueKitPack#mySort"] = "DESC";
    else:
        $_SESSION["BrowseIssueKitPack#myOrder"] = "ORDER BY tcustomer.SurName ASC";
        $_SESSION["BrowseIssueKitPack#mySort"] = "ASC";
    endif;
    if (getRequest("COL") != getSession("BrowseIssueKitPack#PreviousColumn")):
        $_SESSION["BrowseIssueKitPack#myOrder"] = "ORDER BY tcustomer.SurName ASC";
    ...
    $_SESSION["BrowseIssueKitPack#COL"] = "SurName";
    $_SESSION["BrowseIssueKitPack#SRT"] = getSession("BrowseIssueKitPack#mySort");
endif;

if (getRequest("COL") == "FirstName"):
    if (getRequest("SRT") == "DESC"):
        $_SESSION["BrowseIssueKitPack#myOrder"] = "ORDER BY tcustomer.FirstName DESC";
        $_SESSION["BrowseIssueKitPack#mySort"] = "DESC";
    else:
        $_SESSION["BrowseIssueKitPack#myOrder"] = "ORDER BY tcustomer.FirstName ASC";
        $_SESSION["BrowseIssueKitPack#mySort"] = "ASC";
    endif;
    if (getRequest("COL") != getSession("BrowseIssueKitPack#PreviousColumn")):
        $_SESSION["BrowseIssueKitPack#myOrder"] = "ORDER BY tcustomer.FirstName ASC";
    ...
    $_SESSION["BrowseIssueKitPack#COL"] = "FirstName";
    $_SESSION["BrowseIssueKitPack#SRT"] = getSession("BrowseIssueKitPack#mySort");
endif;

if (getRequest("COL") == "MiddleName"):
    if (getRequest("SRT") == "DESC"):
        $_SESSION["BrowseIssueKitPack#myOrder"] = "ORDER BY tcustomer.MiddleName DESC";
        $_SESSION["BrowseIssueKitPack#mySort"] = "DESC";
    else:
        $_SESSION["BrowseIssueKitPack#myOrder"] = "ORDER BY tcustomer.MiddleName ASC";
        $_SESSION["BrowseIssueKitPack#mySort"] = "ASC";
    endif;
    if (getRequest("COL") != getSession("BrowseIssueKitPack#PreviousColumn")):
        $_SESSION["BrowseIssueKitPack#myOrder"] = "ORDER BY tcustomer.MiddleName ASC";
    ...
    $_SESSION["BrowseIssueKitPack#COL"] = "MiddleName";
    $_SESSION["BrowseIssueKitPack#SRT"] = getSession("BrowseIssueKitPack#mySort");
endif;

if (getRequest("COL") == "LSurname"):
    if (getRequest("SRT") == "DESC"):
        $_SESSION["BrowseIssueKitPack#myOrder"] = "ORDER BY tcustomer.LSurname DESC";
        $_SESSION["BrowseIssueKitPack#mySort"] = "DESC";
    else:
        $_SESSION["BrowseIssueKitPack#myOrder"] = "ORDER BY tcustomer.LSurname ASC";
        $_SESSION["BrowseIssueKitPack#mySort"] = "ASC";
    endif;
    if (getRequest("COL") != getSession("BrowseIssueKitPack#PreviousColumn")):
        $_SESSION["BrowseIssueKitPack#myOrder"] = "ORDER BY tcustomer.LSurname ASC";
    ...
    $_SESSION["BrowseIssueKitPack#COL"] = "LSurname";
    $_SESSION["BrowseIssueKitPack#SRT"] = getSession("BrowseIssueKitPack#mySort");
endif;

if (getRequest("COL") == "LFirstName"):
    if (getRequest("SRT") == "DESC"):
        $_SESSION["BrowseIssueKitPack#myOrder"] = "ORDER BY tcustomer.LFirstName DESC";
        $_SESSION["BrowseIssueKitPack#mySort"] = "DESC";
    else:
        $_SESSION["BrowseIssueKitPack#myOrder"] = "ORDER BY tcustomer.LFirstName ASC";
        $_SESSION["BrowseIssueKitPack#mySort"] = "ASC";
    endif;
    if (getRequest("COL") != getSession("BrowseIssueKitPack#PreviousColumn")):
        $_SESSION["BrowseIssueKitPack#myOrder"] = "ORDER BY tcustomer.LFirstName ASC";
    ...
    $_SESSION["BrowseIssueKitPack#COL"] = "LFirstName";
    $_SESSION["BrowseIssueKitPack#SRT"] = getSession("BrowseIssueKitPack#mySort");
endif;
...
if ( getRequest("WHR") != ""):
    ...
    $_SESSION["BrowseIssueKitPack#WHR"] =  getRequest("WHR");
elseif (getSession("BrowseIssueKitPack#WHR") != ""):
    $myWhere    = getSession("BrowseIssueKitPack#WHR");
endif;
...
if ($myWhere == ""):
    if (getRequest("LOCATE") == "TRUE"):
      ...
      $_SESSION["BrowseIssueKitPack#WHR"] = $myWhere;
    endif;
else:
    if(getRequest("LOCATE") == "TRUE"):
        $myWhere .= " AND ";
...
if (getSession("BrowseIssueKitPack#myOrder") == ""):
    $_SESSION["BrowseIssueKitPack#myOrder"] = "ORDER BY tcustomer.CountryID ASC";
    $_SESSION["BrowseIssueKitPack#mySort"] = "ASC";
    $_SESSION["BrowseIssueKitPack#COL"] = "CountryID";
    $_SESSION["BrowseIssueKitPack#SRT"] = getSession("BrowseIssueKitPack#mySort");
...
if (getSession("BrowseIssueKitPack#myOrder") !=""):
    $mySQL .= " " . getSession("BrowseIssueKitPack#myOrder");
endif;
...
if ($oRStcustomer):
    if($oRStcustomer->EOF != TRUE):
        if($oRStcustomer->RecordCount() > 0):
            $oRStcustomer->Move(0);         
            if(getRequest("LOCATE") == "TRUE"):
                $SearchMessage =  "<A href=BrowseIssueKitPack" . "list.php?RESETLIST=TRUE>All data</A>";
            endif;
            MergeBrowseIssueKitPackListTemplate($HTML_Template);
        else:
            NoRecordsFound();
        endif;
    else:
...
function NoRecordsFound() {
    ...
    fclose ($FileObject);
    $tmpMsg = "";
    $tmpMsg = "<a href='BrowseIssueKitPack" . "list.php?RESETLIST=TRUE'>No records were found</a>";
...
/*
=============================================================================
  MergeBrowseIssueKitPackListTemplate($Template)
=============================================================================
*/
function MergeBrowseIssueKitPackListTemplate($Template) {
    global $ClarionData;
    global $SearchField;
    ...
    global $userdata1;
    if($Template == ""):
        $Template = "./html/BrowseIssueKitPacklist.htm";
    endif;      
    $FileObject = fopen($Template, "r");
    $TemplateText = "";
    $TemplateText = fread($FileObject, filesize($Template));
...
function buildColumnLabels() {
    ...
    $myLink = "";
        $myLink = "<a href=\"" . $myPage . "?";
            ...
            if ( getSession("BrowseIssueKitPack#PreviousColumn") == "CountryID"):
                if (getSession("BrowseIssueKitPack#SRT") == "ASC"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                endif;
            else:
                if (getSession("BrowseIssueKitPack#COL") == "CountryID"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                endif;
        ...
        if ( getGet("COL") == "CountryID" || getSession("BrowseIssueKitPack#COL") == "CountryID" ):
            if (getSession("BrowseIssueKitPack#SRT") == "ASC"):
        ...
        $myLink = "<a href=\"" . $myPage . "?";
            $myLink .= "COL=BranchID";
            if ( getSession("BrowseIssueKitPack#PreviousColumn") == "BranchID"):
                if (getSession("BrowseIssueKitPack#SRT") == "ASC"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                ...
                if (getSession("BrowseIssueKitPack#COL") == "BranchID"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                endif;
        ...
        if ( getGet("COL") == "BranchID" || getSession("BrowseIssueKitPack#COL") == "BranchID" ):
            if (getSession("BrowseIssueKitPack#SRT") == "ASC"):
        ...
        $myLink = "<a href=\"" . $myPage . "?";
            $myLink .= "COL=CustNo";
            if ( getSession("BrowseIssueKitPack#PreviousColumn") == "CustNo"):
                if (getSession("BrowseIssueKitPack#SRT") == "ASC"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                ...
                if (getSession("BrowseIssueKitPack#COL") == "CustNo"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                endif;
            ...
            $myLink .= "\">Cust No</a>";
        $CustNoLABEL = $myLink;
        if ( getGet("COL") == "CustNo" || getSession("BrowseIssueKitPack#COL") == "CustNo" ):
            if (getSession("BrowseIssueKitPack#SRT") == "ASC"):
        ...
        $myLink = "<a href=\"" . $myPage . "?";
            ...
            if ( getSession("BrowseIssueKitPack#PreviousColumn") == "StudentID"):
                if (getSession("BrowseIssueKitPack#SRT") == "ASC"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                ...
                if (getSession("BrowseIssueKitPack#COL") == "StudentID"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                endif;
        ...
        if ( getGet("COL") == "StudentID" || getSession("BrowseIssueKitPack#COL") == "StudentID" ):
            if (getSession("BrowseIssueKitPack#SRT") == "ASC"):
        ...
        $myLink = "<a href=\"" . $myPage . "?";
            $myLink .= "COL=SurName";
            if ( getSession("BrowseIssueKitPack#PreviousColumn") == "SurName"):
                if (getSession("BrowseIssueKitPack#SRT") == "ASC"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                ...
                if (getSession("BrowseIssueKitPack#COL") == "SurName"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                endif;
            ...
            $myLink .= "\">Sur Name</a>";
        $SurNameLABEL = $myLink;
        if ( getGet("COL") == "SurName" || getSession("BrowseIssueKitPack#COL") == "SurName" ):
            if (getSession("BrowseIssueKitPack#SRT") == "ASC"):
        ...
        $myLink = "<a href=\"" . $myPage . "?";
            ...
            if ( getSession("BrowseIssueKitPack#PreviousColumn") == "FirstName"):
                if (getSession("BrowseIssueKitPack#SRT") == "ASC"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                ...
                if (getSession("BrowseIssueKitPack#COL") == "FirstName"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                endif;
        ...
        if ( getGet("COL") == "FirstName" || getSession("BrowseIssueKitPack#COL") == "FirstName" ):
            if (getSession("BrowseIssueKitPack#SRT") == "ASC"):
        ...
        $myLink = "<a href=\"" . $myPage . "?";
            ...
            if ( getSession("BrowseIssueKitPack#PreviousColumn") == "MiddleName"):
                if (getSession("BrowseIssueKitPack#SRT") == "ASC"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                ...
                if (getSession("BrowseIssueKitPack#COL") == "MiddleName"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                endif;
        ...
        if ( getGet("COL") == "MiddleName" || getSession("BrowseIssueKitPack#COL") == "MiddleName" ):
            if (getSession("BrowseIssueKitPack#SRT") == "ASC"):
        ...
        $myLink = "<a href=\"" . $myPage . "?";
            $myLink .= "COL=LSurname";
            if ( getSession("BrowseIssueKitPack#PreviousColumn") == "LSurname"):
                if (getSession("BrowseIssueKitPack#SRT") == "ASC"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                ...
                if (getSession("BrowseIssueKitPack#COL") == "LSurname"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                endif;
        ...
        if ( getGet("COL") == "LSurname" || getSession("BrowseIssueKitPack#COL") == "LSurname" ):
            if (getSession("BrowseIssueKitPack#SRT") == "ASC"):
        ...
        $myLink = "<a href=\"" . $myPage . "?";
            ...
            if ( getSession("BrowseIssueKitPack#PreviousColumn") == "LFirstName"):
                if (getSession("BrowseIssueKitPack#SRT") == "ASC"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                ...
                if (getSession("BrowseIssueKitPack#COL") == "LFirstName"):
                    $myLink .= "&SRT=DESC";
                else:
                    $myLink .= "&SRT=ASC";
                endif;
        ...
        if ( getGet("COL") == "LFirstName" || getSession("BrowseIssueKitPack#COL") == "LFirstName" ):
            if (getSession("BrowseIssueKitPack#SRT") == "ASC"):
...
$Seq = 0;
    ...
    $myLink = "";
            $myLink = "<a href=\"BrowseKitPacklist.php?ID1=";
            ...
            $tmpIMG_tcustomerAutomaticDetailLink = "<img src=\"/images/editpencil.gif\" border=\"0\" alt=\"Issue Kit Pack\">";
