...
function MergeAddTemplate($Template) {
    ...
    if(!isset($Template) || ($Template =="")):
        $Template =  "./html/Updatetastatusadd.htm";
    endif;
...
$UpdatetastatusFormAction = "Updatetastatusaddx.php";
$tastatusCountryID  = getRequest("txttastatusCountryID");
$tastatusBranchID  = getRequest("txttastatusBranchID");
$tastatusID  = getRequest("txttastatusID");
$tastatusDescription  = getRequest("txttastatusDescription");

if ($_SESSION["Updatetastatus_InsertFailed"] == 1) {
   $tastatusCountryID = $_SESSION["SavedtastatusCountryID"];
   $tastatusBranchID = $_SESSION["SavedtastatusBranchID"];
   $tastatusID = $_SESSION["SavedtastatusID"];
   $tastatusDescription = $_SESSION["SavedtastatusDescription"];
}
