...
$DeleteButton = "";
$UpdatetroomFormAction = "";
//============================================================================='
// MergeTemplate 
//============================================================================='
function MergeTemplate($Template) {
    if(!isset($Template) || ($Template =="")):
        $Template = "./html/Updatetroom" . "edit.htm";
    endif;
    global $DeleteButton;   
    global $Header;   
    global $Footer;   
...
$UpdatetroomFormAction = "Updatetroomeditx.php";
$oRStroomCountryID = $oRStroom->fields["CountryID"];
$oRStroomBranchID = $oRStroom->fields["BranchID"];
$oRStroomID = $oRStroom->fields["ID"];
...
$troomCountryID = trim(getValue($oRStroom->fields["CountryID"]));
endif;
$troomBranchID = "";
if (is_null($oRStroom->fields["BranchID"])):
$troomBranchID = "";
else:
$troomBranchID = trim(getValue($oRStroom->fields["BranchID"]));
endif;
$troomID = "";
...
$troomDescription = trim(getValue($oRStroom->fields["Description"]));
endif;
$troomTotalSeat = "";
...
$DeleteButton = "<form method='post' action='Updatetroomdel.php' id='form1' name='form1'>";
...
if ($_SESSION["Updatetroom_EditFailed"] == 1) {
  $troomCountryID = $_SESSION["SavedEdittroomCountryID"];
  $troomBranchID = $_SESSION["SavedEdittroomBranchID"];
  $troomID = $_SESSION["SavedEdittroomID"];
  $troomDescription = $_SESSION["SavedEdittroomDescription"];
  $troomTotalSeat = $_SESSION["SavedEdittroomTotalSeat"];
}
else {
