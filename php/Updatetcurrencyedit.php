...
$DeleteButton = "";
$UpdatetcurrencyFormAction = "";
//============================================================================='
// MergeTemplate 
//============================================================================='
function MergeTemplate($Template) {
    if(!isset($Template) || ($Template =="")):
        $Template = "./html/Updatetcurrency" . "edit.htm";
    endif;
    global $DeleteButton;   
    global $Header;   
    global $Footer;   
...
$UpdatetcurrencyFormAction = "Updatetcurrencyeditx.php";
$oRStcurrencyCountryID = $oRStcurrency->fields["CountryID"];
$oRStcurrencyBranchID = $oRStcurrency->fields["BranchID"];
$oRStcurrencyID = $oRStcurrency->fields["ID"];
...
$tcurrencyCountryID = trim(getValue($oRStcurrency->fields["CountryID"]));
endif;
$tcurrencyBranchID = "";
if (is_null($oRStcurrency->fields["BranchID"])):
$tcurrencyBranchID = "";
else:
$tcurrencyBranchID = trim(getValue($oRStcurrency->fields["BranchID"]));
endif;
$tcurrencyID = "";
if (is_null($oRStcurrency->fields["ID"])):
$tcurrencyID = "";
else:
$tcurrencyID = trim(getValue($oRStcurrency->fields["ID"]));
endif;
$tcurrencyDescription = "";
if (is_null($oRStcurrency->fields["Description"])):
$tcurrencyDescription = "";
else:
$tcurrencyDescription = trim(getValue($oRStcurrency->fields["Description"]));
endif;
$tcurrencyRate = "";
...
$tcurrencySymbol = trim(getValue($oRStcurrency->fields["Symbol"]));
endif;
$DeleteLevel = 1;
if (isset($DeleteLevel) && getSession("UserLevel") >= $DeleteLevel):
$DeleteButton = "<form method='post' action='Updatetcurrencydel.php' id='form1' name='form1'>";
...
if ($_SESSION["Updatetcurrency_EditFailed"] == 1) {
  $tcurrencyCountryID = $_SESSION["SavedEdittcurrencyCountryID"];
  $tcurrencyBranchID = $_SESSION["SavedEdittcurrencyBranchID"];
  $tcurrencyID = $_SESSION["SavedEdittcurrencyID"];
  $tcurrencyDescription = $_SESSION["SavedEdittcurrencyDescription"];
  $tcurrencyRate = $_SESSION["SavedEdittcurrencyRate"];
  $tcurrencySymbol = $_SESSION["SavedEdittcurrencySymbol"];
}
else {
