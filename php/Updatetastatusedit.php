...
$DeleteButton = "";
$UpdatetastatusFormAction = "";
//============================================================================='
// MergeTemplate 
//============================================================================='
function MergeTemplate($Template) {
    if(!isset($Template) || ($Template =="")):
        $Template = "./html/Updatetastatus" . "edit.htm";
    endif;
    global $DeleteButton;   
    global $Header;   
    global $Footer;   
...
$UpdatetastatusFormAction = "Updatetastatuseditx.php";
$oRStastatusCountryID = $oRStastatus->fields["CountryID"];
$oRStastatusBranchID = $oRStastatus->fields["BranchID"];
$oRStastatusID = $oRStastatus->fields["ID"];
...
$tastatusCountryID = trim(getValue($oRStastatus->fields["CountryID"]));
endif;
$tastatusBranchID = "";
if (is_null($oRStastatus->fields["BranchID"])):
$tastatusBranchID = "";
else:
$tastatusBranchID = trim(getValue($oRStastatus->fields["BranchID"]));
endif;
$tastatusID = "";
...
$tastatusDescription = trim(getValue($oRStastatus->fields["Description"]));
endif;
$DeleteButton = "<form method='post' action='Updatetastatusdel.php' id='form1' name='form1'>";
...
if ($_SESSION["Updatetastatus_EditFailed"] == 1) {
  $tastatusCountryID = $_SESSION["SavedEdittastatusCountryID"];
  $tastatusBranchID = $_SESSION["SavedEdittastatusBranchID"];
  $tastatusID = $_SESSION["SavedEdittastatusID"];
  $tastatusDescription = $_SESSION["SavedEdittastatusDescription"];
}
else {
