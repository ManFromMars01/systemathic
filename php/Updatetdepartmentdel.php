...
if ($myFormAction == "3") {
    ...
    $mySQL = "DELETE FROM tdepartment WHERE  tdepartment.CountryID = '" . $ID1 . "'" . " AND tdepartment.BranchID = '" . $ID2 . "'" . " AND tdepartment.ID = " . $ID3;
...
if (!$myFormAction == "3"):
    ...
    if(getSession("BrowseDept#WHR") != ""):
        $ClarionData .= "<a href=BrowseDept" . "list.php?SUBSET=TRUE>Return to list</a>\n";
    else:
