...
$DeleteButton = "";
$UpdatetdiscountFormAction = "";
//============================================================================='
// MergeTemplate 
//============================================================================='
function MergeTemplate($Template) {
    if(!isset($Template) || ($Template =="")):
        $Template = "./html/Updatetdiscount" . "edit.htm";
    endif;
    global $DeleteButton;   
    global $Header;   
    global $Footer;   
...
$UpdatetdiscountFormAction = "Updatetdiscounteditx.php";
$oRStdiscountCountryID = $oRStdiscount->fields["CountryID"];
$oRStdiscountBranchID = $oRStdiscount->fields["BranchID"];
$oRStdiscountCode = $oRStdiscount->fields["Code"];
...
$tdiscountCountryID = trim(getValue($oRStdiscount->fields["CountryID"]));
endif;
$tdiscountBranchID = "";
if (is_null($oRStdiscount->fields["BranchID"])):
$tdiscountBranchID = "";
else:
$tdiscountBranchID = trim(getValue($oRStdiscount->fields["BranchID"]));
endif;
$tdiscountCode = "";
if (is_null($oRStdiscount->fields["Code"])):
$tdiscountCode = "";
else:
$tdiscountCode = trim(getValue($oRStdiscount->fields["Code"]));
endif;
$tdiscountDescription = "";
if (is_null($oRStdiscount->fields["Description"])):
$tdiscountDescription = "";
else:
$tdiscountDescription = trim(getValue($oRStdiscount->fields["Description"]));
endif;
$tdiscountDiscount = "";
...
$DeleteButton = "<form method='post' action='Updatetdiscountdel.php' id='form1' name='form1'>";
...
if ($_SESSION["Updatetdiscount_EditFailed"] == 1) {
  $tdiscountCountryID = $_SESSION["SavedEdittdiscountCountryID"];
  $tdiscountBranchID = $_SESSION["SavedEdittdiscountBranchID"];
  $tdiscountCode = $_SESSION["SavedEdittdiscountCode"];
  $tdiscountDescription = $_SESSION["SavedEdittdiscountDescription"];
  $tdiscountDiscount = $_SESSION["SavedEdittdiscountDiscount"];
}
else {
