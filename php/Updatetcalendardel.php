...
if ($myFormAction == "3") {
    ...
    $mySQL = "DELETE FROM tcalendar WHERE  tcalendar.CountryID = '" . $ID1 . "'" . " AND tcalendar.BranchID = '" . $ID2 . "'" . " AND tcalendar.Date = '" . $ID3 . "'";
...
if (!$myFormAction == "3"):
    ...
    if(getSession("BrowseSchoolCalendar#WHR") != ""):
        $ClarionData .= "<a href=BrowseSchoolCalendar" . "list.php?SUBSET=TRUE>Return to list</a>\n";
    else:
