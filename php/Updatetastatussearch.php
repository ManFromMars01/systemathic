...
if (getRequest("txttastatusCountryID") == ""):
    ...
    $myWhere .= " tastatus.CountryID LIKE " . chr(39) . getRequest("txttastatusCountryID") . "%" . chr(39);
endif;
...
if (getRequest("txttastatusBranchID") == ""):
    ...
    $myWhere .= " tastatus.BranchID LIKE " . chr(39) . getRequest("txttastatusBranchID") . "%" . chr(39);
endif;
...
if (getRequest("txttastatusID") == ""):
    ...
    $myWhere .= " tastatus.ID = " . getRequest("txttastatusID");
endif;
...
if (getRequest("txttastatusDescription") == ""):
    ...
    $myWhere .= " tastatus.Description LIKE " . chr(39) . getRequest("txttastatusDescription") . "%" . chr(39);
endif;
...
function MergeSearchTemplate($Template) {
    ...
    if(!isset($Template) || ($Template =="")):
        $Template = "./html/Updatetastatus" . "search.htm";
    endif;
...
$FormDeclaration .=  "Updatetastatus" . "search.php". "\">" . "\n<input type=\"HIDDEN\" id=\"SEARCH\" name=\"SEARCH\" value=\"TRUE\">";
endif;
