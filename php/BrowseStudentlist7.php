...
//Count me
$myWhere2 .= "tcustomer.CountryID ='".$_SESSION["UserValue1"]."' AND tcustomer.RegType = 'For Kit Issuance' ";
...
$myWhere .= "tcustomer.CountryID = " . $strMyQuote . getSession("UserValue1") . $strMyQuote."AND tcustomer.RegType = 'For Kit Issuance' ";
...
function MergeBrowseStudentListTemplate($Template) {
    ...
    global $userdata1;
    if($Template == ""):
        $Template = "./html/BrowseStudentlist7.htm";
    endif;      
    $FileObject = fopen($Template, "r");
    $TemplateText = "";
    $TemplateText = fread($FileObject, filesize($Template));
...
$Seq = 0;
    ...
    $myLink = "";
            $myLink = "<a class='btn btn-info' href=\"kitissuance.php?ID1=";
            ...
            $tmpIMG_tcustomerAutomaticDetailLink = "<i class='icon-edit icon-white'></i> Kit Issuance";
