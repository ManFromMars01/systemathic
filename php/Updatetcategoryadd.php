...
function MergeAddTemplate($Template) {
    ...
    if(!isset($Template) || ($Template =="")):
        $Template =  "./html/Updatetcategoryadd.htm";
    endif;
...
$UpdatetcategoryFormAction = "Updatetcategoryaddx.php";
$tcategoryCountryID  = getRequest("txttcategoryCountryID");
$tcategoryBranchID  = getRequest("txttcategoryBranchID");
$tcategoryID  = getRequest("txttcategoryID");
$tcategoryDescription  = getRequest("txttcategoryDescription");

if ($_SESSION["Updatetcategory_InsertFailed"] == 1) {
   $tcategoryCountryID = $_SESSION["SavedtcategoryCountryID"];
   $tcategoryBranchID = $_SESSION["SavedtcategoryBranchID"];
   $tcategoryID = $_SESSION["SavedtcategoryID"];
   $tcategoryDescription = $_SESSION["SavedtcategoryDescription"];
}
