...
function MergeAddTemplate($Template) {
    ...
    if(!isset($Template) || ($Template =="")):
        $Template =  "./html/Updatetunitmeasadd.htm";
    endif;
...
$UpdatetunitmeasFormAction = "Updatetunitmeasaddx.php";
$tunitmeasCountryID  = getRequest("txttunitmeasCountryID");
$tunitmeasBranchID  = getRequest("txttunitmeasBranchID");
$tunitmeasID  = getRequest("txttunitmeasID");
$tunitmeasDescription  = getRequest("txttunitmeasDescription");

if ($_SESSION["Updatetunitmeas_InsertFailed"] == 1) {
   $tunitmeasCountryID = $_SESSION["SavedtunitmeasCountryID"];
   $tunitmeasBranchID = $_SESSION["SavedtunitmeasBranchID"];
   $tunitmeasID = $_SESSION["SavedtunitmeasID"];
   $tunitmeasDescription = $_SESSION["SavedtunitmeasDescription"];
}
