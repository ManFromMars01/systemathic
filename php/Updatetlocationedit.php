...
$DeleteButton = "";
$UpdatetlocationFormAction = "";
//============================================================================='
// MergeTemplate 
//============================================================================='
function MergeTemplate($Template) {
    if(!isset($Template) || ($Template =="")):
        $Template = "./html/Updatetlocation" . "edit.htm";
    endif;
    global $DeleteButton;   
    global $Header;   
    global $Footer;   
...
$UpdatetlocationFormAction = "Updatetlocationeditx.php";
$oRStlocationCountryID = $oRStlocation->fields["CountryID"];
$oRStlocationBranchID = $oRStlocation->fields["BranchID"];
$oRStlocationID = $oRStlocation->fields["ID"];
...
$tlocationCountryID = trim(getValue($oRStlocation->fields["CountryID"]));
endif;
$tlocationBranchID = "";
if (is_null($oRStlocation->fields["BranchID"])):
$tlocationBranchID = "";
else:
$tlocationBranchID = trim(getValue($oRStlocation->fields["BranchID"]));
endif;
$tlocationID = "";
...
$tlocationDescription = trim(getValue($oRStlocation->fields["Description"]));
endif;
$DeleteLevel = 1;
if (isset($DeleteLevel) && getSession("UserLevel") >= $DeleteLevel):
$DeleteButton = "<form method='post' action='Updatetlocationdel.php' id='form1' name='form1'>";
...
if ($_SESSION["Updatetlocation_EditFailed"] == 1) {
  $tlocationCountryID = $_SESSION["SavedEdittlocationCountryID"];
  $tlocationBranchID = $_SESSION["SavedEdittlocationBranchID"];
  $tlocationID = $_SESSION["SavedEdittlocationID"];
  $tlocationDescription = $_SESSION["SavedEdittlocationDescription"];
}
else {
