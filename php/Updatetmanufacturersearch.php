...
if (getRequest("txttmanufacturerCountryID") == ""):
    ...
    $myWhere .= " tmanufacturer.CountryID LIKE " . chr(39) . getRequest("txttmanufacturerCountryID") . "%" . chr(39);
endif;
...
if (getRequest("txttmanufacturerBranchID") == ""):
    ...
    $myWhere .= " tmanufacturer.BranchID LIKE " . chr(39) . getRequest("txttmanufacturerBranchID") . "%" . chr(39);
endif;
...
if (getRequest("txttmanufacturerID") == ""):
    ...
    $myWhere .= " tmanufacturer.ID = " . getRequest("txttmanufacturerID");
endif;
...
if (getRequest("txttmanufacturerDescription") == ""):
    ...
    $myWhere .= " tmanufacturer.Description LIKE " . chr(39) . getRequest("txttmanufacturerDescription") . "%" . chr(39);
endif;
...
function MergeSearchTemplate($Template) {
    ...
    if(!isset($Template) || ($Template =="")):
        $Template = "./html/Updatetmanufacturer" . "search.htm";
    endif;
...
$FormDeclaration .=  "Updatetmanufacturer" . "search.php". "\">" . "\n<input type=\"HIDDEN\" id=\"SEARCH\" name=\"SEARCH\" value=\"TRUE\">";
endif;
