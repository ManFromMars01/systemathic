            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    <div class="box-header well" data-original-title>
                        <h2><i class="icon-edit"></i>Update Collection List</h2>
                        <div class="box-icon">
                        ...
                        <form class="form-horizontal" action=""  id="form22" name="form22" method="post" >
                          <fieldset>
                            <div class="control-group">
                                <input name="id" type="hidden" id="id" value="<?php echo $collections->fields['ID']; ?>">
                                <label class="control-label" for="focusedInput">Description:</label>
                                <div class="controls">
                                    <textarea name="description" id="description" required><?php echo $collections->fields['Description']; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                  <input name="code" type="text" id="code" value="<?php echo $collections->fields['Code']; ?>" required>
                                </div>
                            </div>
