            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    <div class="box-header well" data-original-title>
                        <h2><i class="icon-edit"></i> Update Size</h2>
                        <div class="box-icon">
                        ...
                        <form class="form-horizontal" action=""  id="form22" name="form22" method="post" >
                          <fieldset>
                            <div class="control-group">
                                <input name="id" type="hidden" id="id" value="<?php echo $size->fields['ID']; ?>">
                                <label class="control-label" for="focusedInput">Description:</label>
                                <div class="controls">
                                    <textarea name="description" id="description" required><?php echo $size->fields['Description']; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                  <input name="code" type="text" id="code" value="<?php echo $size->fields['Code']; ?>" required>
                                </div>
                            </div>
