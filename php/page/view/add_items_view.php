                        ...
                        <form class="form-horizontal" action="@UpdatetStudentFormAction@"  id="form31" name="form31" method="post" >
                          <fieldset>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                  <input style="width:50px;"  class="" name="txttitemsItemNo" id="" type="text" value="" required> 
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                  <select name="design" id="design">
                                        ...
                                        <option value="<?php echo $designs['Code'] ?>"><?php echo $designs['Description'];?></option>
                                        <?php endforeach; ?>
                                  </select>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                  <div class="input-prepend">
                                    <span class="add-on">TWD</span><input name="txttitemsIssuUntCost" id="prependedInput" size="16" type="text">
                                  </div>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                  <div class="input-prepend">
                                    <span class="add-on">TWD</span><input name="txttitemsPurUntCost" id="prependedInput" size="16" type="text">
                                  </div>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                  <div class="input-prepend">  
                                    <span class="add-on">TWD</span><input name="txttitemsStdCost" id="prependedInput" size="16" type="text">
                                  </div>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                  <input class="" style="width:100px;" name="txttitemsQtyOnHand" id="" type="text" value="">
                                </div>
                            </div>    
