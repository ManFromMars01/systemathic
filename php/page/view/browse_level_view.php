            ...
            <div class="row-fluid sortable">        
                <div class="box span12">
                    <div class="box-header well" data-original-title>
                        <h2><i class="icon-user"></i> Levels</h2>
                    </div>
                    
                    <div class="box-content">
                        <a class="btn btn-success" href="<?php echo base_url('page/controller/add_level.php');?>">Add Level </a>
                        <br><br >
                        <table class="table table-striped table-bordered bootstrap-datatable datatable">
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-success" href="<?php echo base_url('page/controller/update_level.php?level_id='.$levels['ID']);?>"> Edit Level </a></td>   
                            </tr>     
                            <?php endforeach; ?>
