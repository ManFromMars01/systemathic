<div id="content" class="span10">
            ...
            <?php breadcrumb('<a href="'.base_url('franchising.php').'">Franchising</a> / <a href="#">Country Franchisor</a>'); ?>
            
            <div class="row-fluid sortable">        
                <div class="box span12">
                    <div class="box-header well" data-original-title>
                        <h2><i class="icon-user"></i> Country Franchisor </h2>
                        <div class="box-icon">
                        ...
                        <table class="table table-striped table-bordered bootstrap-datatable datatable">
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $countries['Address2']; ?></td>
                                <td><a href="tel:<?php echo $countries['Phone']; ?>"><?php echo $countries['Phone']; ?></a></td>
