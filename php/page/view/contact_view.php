							...
							<div class="tab-pane" id="register">
								...
								<table width="auto" height="auto" align="center" style="margin-bottom:10px;">
									...
									<tr>
										<td></td>
									    <td></td>
									    <td><img src="<?php echo base_url();?>template/img/contact/register.png"></td>
									    <td></td>
									    <td></td>
									...
									<tr>
										<td colspan="5"><img src="<?php echo base_url();?>template/img/contact/arrow1.png"></td>
									
									</tr>

									<tr>
										<td><a href="<?php echo base_url('page/controller/appointment.php');?>"><img src="<?php echo base_url();?>template/img/contact/appointment.png"></a></td>
									    <td><a href="<?php echo base_url('page/controller/communication_log.php');?>"><img src="<?php echo base_url();?>template/img/contact/parent.png"></td>
									    <td><a href="<?php echo base_url('page/controller/reminder.php')?>"><img src="<?php echo base_url();?>template/img/contact/reminders.png"></td>
									    <td><img src="<?php echo base_url();?>template/img/contact/order.png"></td>
									    <td><img src="<?php echo base_url();?>template/img/contact/receivable.png"></td>
									</tr>
