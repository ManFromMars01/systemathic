...
$levelfile = $model->select_where('tclasssched',array('LevelID' => $level_no));
      ...
      <div class="row-fluid sortable">
        <div class="box span12">
          <div class="box-header well" data-original-title>
            <h2><i class="icon-calendar"></i>Level Schedule</h2>
            <div class="box-icon">
...
//initialize the external events for calender
  ...
  $('#calendar').fullCalendar({
    ...
    events: [
          ...
          <?php
          foreach ($levelfile as $lsched): 
          $day_label = $lsched['Day']; 
          $date_day = date('Y-m-d',strtotime('this '.$day_label));
          $selectlevel = $model->select_where('tlevel',array('ID' =>$lsched['LevelID']  ));
          ...
          ?>
           {
                  title: ' <?php echo $level_code; ?>(<?php echo $lsched['TimeFrom']; ?> -  <?php echo $lsched['TimeTo']; ?>)  ',
                  allDay:false,
                  start: '<?php echo $date_day2; ?> <?php echo $lsched['TimeFrom']; ?>',
                  end: '<?php echo $date_day2; ?> <?php echo $lsched['TimeTo']; ?>' ,
                  description: '<?php echo $lsched['TimeFrom']; ?> - <?php echo $lsched['TimeTo']; ?>',
