...
/**Begin selected_item**/
$sel_item = "SELECT *  FROM titems  WHERE  titems.Sku='".$ID3."'";
...
/**Begin Department**/
$seldepartment = "SELECT *  FROM tdepartment";
...
/**Begin Location**/
$sellocation = "SELECT *  FROM tlocation";
...
/**Begin Design**/
$selldesign = "SELECT *  FROM tdesign";
$optiondesign =  "<option value=''>Please Select A Design</option>";
$selldesign = $objConn1->Execute($selldesign);
foreach ($selldesign as $selldesigns):
        $optiondesign .= "<option value='".$selldesigns['Code']."'>".$selldesigns['Description']." </option>";
endforeach;
/**End Design**/
...
/**Begin Category**/
$selcategory = "SELECT *  FROM tcollection";
$option7 =  "<option value=''>Please Select A Collection</option>";
$selcategory = $objConn1->Execute($selcategory);
foreach ($selcategory as $selcategorys):
        if($catid == $selcategorys['Code']){
          $selected = "selected";                     
        } else{
          $selected = "";      
        }

        $option7 .= "<option " .$selected. " value='".$selcategorys['Code']."'>".$selcategorys['Description']." </option>";
endforeach;
/**End Category**/

/**Begin Vendor**/
$selvendor = "SELECT *  FROM tvendor";
$option8 =  "<option value=''>Please Select A Vendor</option>";
$selvendor = $objConn1->Execute($selvendor);
foreach ($selvendor as $selvendor):
        if($selvendor['Code'] == $venid){
                $selected = "selected";
        } else {
                $selected = "";
        }
        $option8 .= "<option ".$selected." value='".$selvendor['Code']."'>".$selvendor['Name']." </option>";
endforeach;
/**End Vendor**/

/**Unit of Measure **/
$selumea = "SELECT *  FROM tunitmeas";
...
/**Abacus Books**/
$selbooks = "SELECT *  FROM titems WHERE titems.IsBook='Yes'";
...
/**Mental Books**/
$selbooks2 = "SELECT *  FROM titems WHERE titems.IsBook='Yes' ";
...
/**Supplementary Books**/
$selbooks3 = "SELECT *  FROM titems WHERE titems.IsBook='Yes' ";
...
/**Abacus Books**/
$selbooks = "SELECT *  FROM titems WHERE  titems.IsBook='Yes' AND titems.IsAbacus='Yes'";
$selbooks = $objConn1->Execute($selbooks); 
$option4 = "";   
foreach ($selbooks as $selbook):
...
/**Mental Books**/
$selbooks2 = "SELECT *  FROM titems WHERE  titems.IsBook='Yes' AND titems.IsMental='Yes'";
$selbooks2 = $objConn1->Execute($selbooks2);
$option5 = "";
foreach ($selbooks2 as $selbook2):
...
$selbooks3 = "SELECT *  FROM titems WHERE titems.IsBook='Yes' AND titems.IsSupp='Yes'";
$selbooks3 = $objConn1->Execute($selbooks3);
$option6 = "";
foreach ($selbooks3 as $selbook3):
