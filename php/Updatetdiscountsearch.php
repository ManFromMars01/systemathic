...
if (getRequest("txttdiscountCountryID") == ""):
    ...
    $myWhere .= " tdiscount.CountryID LIKE " . chr(39) . getRequest("txttdiscountCountryID") . "%" . chr(39);
endif;
...
if (getRequest("txttdiscountBranchID") == ""):
    ...
    $myWhere .= " tdiscount.BranchID LIKE " . chr(39) . getRequest("txttdiscountBranchID") . "%" . chr(39);
endif;
...
if (getRequest("txttdiscountCode") == ""):
    ...
    $myWhere .= " tdiscount.Code LIKE " . chr(39) . getRequest("txttdiscountCode") . "%" . chr(39);
endif;
...
if (getRequest("txttdiscountDescription") == ""):
    ...
    $myWhere .= " tdiscount.Description LIKE " . chr(39) . getRequest("txttdiscountDescription") . "%" . chr(39);
endif;

if (getRequest("txttdiscountDiscount") == ""):
else:
    if ($myWhere == ""):
    else:
       $myWhere .= " AND ";
    endif;
    $myWhere .= " tdiscount.Discount = " . getRequest("txttdiscountDiscount");
endif;
...
function MergeSearchTemplate($Template) {
    ...
    if(!isset($Template) || ($Template =="")):
        $Template = "./html/Updatetdiscount" . "search.htm";
    endif;
...
$FormDeclaration .=  "Updatetdiscount" . "search.php". "\">" . "\n<input type=\"HIDDEN\" id=\"SEARCH\" name=\"SEARCH\" value=\"TRUE\">";
endif;
