...
if ($myFormAction == "3") {
    ...
    $mySQL = "DELETE FROM tcustomer WHERE  tcustomer.CountryID = '" . $ID1 . "'" . " AND tcustomer.BranchID = '" . $ID2 . "'" . " AND tcustomer.CustNo = " . $ID3;
...
if (!$myFormAction == "3"):
    ...
    if(getSession("BrowseStudent#WHR") != ""):
        $ClarionData .= "<a href=BrowseStudent" . "list.php?SUBSET=TRUE>Return to list</a>\n";
    else:
