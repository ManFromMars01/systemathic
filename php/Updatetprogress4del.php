...
if ($myFormAction == "3") {
    ...
    $mySQL = "DELETE FROM tprogress4 WHERE  tprogress4.CountryID = '" . $ID1 . "'" . " AND tprogress4.BranchID = '" . $ID2 . "'" . " AND tprogress4.Level1ID = '" . $ID3 . "'" . " AND tprogress4.Level2ID = '" . $ID4 . "'" . " AND tprogress4.Level3ID = '" . $ID5 . "'" . " AND tprogress4.Rating = " . $ID6;
...
if (!$myFormAction == "3"):
    ...
    $ClarionData .= "<input type='hidden' id='ID4' name='ID4' value='" . $ID4 . "'>\n";
    $ClarionData .= "<input type='hidden' id='ID5' name='ID5' value='" . $ID5 . "'>\n";
    $ClarionData .= "<input type='hidden' id='ID6' name='ID6' value='" . $ID6 . "'>\n";
