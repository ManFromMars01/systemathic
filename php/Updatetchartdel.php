...
if ($myFormAction == "3") {
    ...
    $mySQL = "DELETE FROM tchart WHERE  tchart.CountryID = '" . $ID1 . "'" . " AND tchart.BranchID = '" . $ID2 . "'" . " AND tchart.AccountNo = " . $ID3 . " AND tchart.DeptNo = " . $ID4;
...
if (!$myFormAction == "3"):
    ...
    if(getSession("BrowseChart#WHR") != ""):
        $ClarionData .= "<a href=BrowseChart" . "list.php?SUBSET=TRUE>Return to list</a>\n";
    else:
