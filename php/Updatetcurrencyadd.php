...
function MergeAddTemplate($Template) {
    ...
    if(!isset($Template) || ($Template =="")):
        $Template =  "./html/Updatetcurrencyadd.htm";
    endif;
...
$UpdatetcurrencyFormAction = "Updatetcurrencyaddx.php";
$tcurrencyCountryID  = getRequest("txttcurrencyCountryID");
$tcurrencyBranchID  = getRequest("txttcurrencyBranchID");
$tcurrencyID  = getRequest("txttcurrencyID");
$tcurrencyDescription  = getRequest("txttcurrencyDescription");
$tcurrencyRate  = getRequest("txttcurrencyRate");
$tcurrencySymbol  = getRequest("txttcurrencySymbol");

if ($_SESSION["Updatetcurrency_InsertFailed"] == 1) {
   $tcurrencyCountryID = $_SESSION["SavedtcurrencyCountryID"];
   $tcurrencyBranchID = $_SESSION["SavedtcurrencyBranchID"];
   $tcurrencyID = $_SESSION["SavedtcurrencyID"];
   $tcurrencyDescription = $_SESSION["SavedtcurrencyDescription"];
   $tcurrencyRate = $_SESSION["SavedtcurrencyRate"];
   $tcurrencySymbol = $_SESSION["SavedtcurrencySymbol"];
}
