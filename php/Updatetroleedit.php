...
$DeleteButton = "";
$UpdatetroleFormAction = "";
//============================================================================='
// MergeTemplate 
//============================================================================='
function MergeTemplate($Template) {
    if(!isset($Template) || ($Template =="")):
        $Template = "./html/Updatetrole" . "edit.htm";
    endif;
    global $DeleteButton;   
    global $Header;   
    global $Footer;   
...
$UpdatetroleFormAction = "Updatetroleeditx.php";
$oRStroleCountryID = $oRStrole->fields["CountryID"];
$oRStroleBranchID = $oRStrole->fields["BranchID"];
$oRStroleRoleID = $oRStrole->fields["RoleID"];
...
$troleCountryID = trim(getValue($oRStrole->fields["CountryID"]));
endif;
$troleBranchID = "";
if (is_null($oRStrole->fields["BranchID"])):
$troleBranchID = "";
else:
$troleBranchID = trim(getValue($oRStrole->fields["BranchID"]));
endif;
$troleRoleID = "";
if (is_null($oRStrole->fields["RoleID"])):
$troleRoleID = "";
else:
$troleRoleID = trim(getValue($oRStrole->fields["RoleID"]));
endif;
$troleDescription = "";
if (is_null($oRStrole->fields["Description"])):
$troleDescription = "";
else:
$troleDescription = trim(getValue($oRStrole->fields["Description"]));
endif;
$troleSecurityLevel = "";
...
$DeleteButton = "<form method='post' action='Updatetroledel.php' id='form1' name='form1'>";
...
if ($_SESSION["Updatetrole_EditFailed"] == 1) {
  $troleCountryID = $_SESSION["SavedEdittroleCountryID"];
  $troleBranchID = $_SESSION["SavedEdittroleBranchID"];
  $troleRoleID = $_SESSION["SavedEdittroleRoleID"];
  $troleDescription = $_SESSION["SavedEdittroleDescription"];
  $troleSecurityLevel = $_SESSION["SavedEdittroleSecurityLevel"];
}
else {
