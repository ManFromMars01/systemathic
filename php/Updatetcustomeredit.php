...
$DeleteButton = "";
$UpdatetcustomerFormAction = "";
//============================================================================='
// MergeTemplate 
//============================================================================='
function MergeTemplate($Template) {
    if(!isset($Template) || ($Template =="")):
        $Template = "./html/Updatetcustomer" . "edit.htm";
    endif;
    global $DeleteButton;   
    global $ID1;
    global $ID2;
    global $ID3;
    global $UpdatetcustomerFormAction;
    ...
    $TemplateText = Replace($TemplateText,"@UpdatetcustomerFormAction@",$UpdatetcustomerFormAction);    
...
$UpdatetcustomerFormAction = "Updatetcustomereditx.php";
...
$DeleteButton = "<form method='post' action='Updatetcustomerdel.php' id='form1' name='form1'>";
...
if ($_SESSION["Updatetcustomer_EditFailed"] == 1) {
  ...
  $_SESSION["Updatetcustomer_EditFailed"] = 0;
}
