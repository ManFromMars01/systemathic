...
function MergeAddTemplate($Template) {
    ...
    if(!isset($Template) || ($Template =="")):
        $Template =  "./html/Updatetassessmentadd.htm";
    endif;
...
$UpdatetassessmentFormAction = "Updatetassessmentaddx.php";
$tassessmentCountryID  = getRequest("txttassessmentCountryID");
$tassessmentBranchID  = getRequest("txttassessmentBranchID");
$tassessmentID  = getRequest("txttassessmentID");
$tassessmentDescription  = getRequest("txttassessmentDescription");

if ($_SESSION["Updatetassessment_InsertFailed"] == 1) {
   $tassessmentCountryID = $_SESSION["SavedtassessmentCountryID"];
   $tassessmentBranchID = $_SESSION["SavedtassessmentBranchID"];
   $tassessmentID = $_SESSION["SavedtassessmentID"];
   $tassessmentDescription = $_SESSION["SavedtassessmentDescription"];
}
