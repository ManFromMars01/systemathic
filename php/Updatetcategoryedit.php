...
$DeleteButton = "";
$UpdatetcategoryFormAction = "";
//============================================================================='
// MergeTemplate 
//============================================================================='
function MergeTemplate($Template) {
    if(!isset($Template) || ($Template =="")):
        $Template = "./html/Updatetcategory" . "edit.htm";
    endif;
    global $DeleteButton;   
    global $Header;   
    global $Footer;   
...
$UpdatetcategoryFormAction = "Updatetcategoryeditx.php";
$oRStcategoryCountryID = $oRStcategory->fields["CountryID"];
$oRStcategoryBranchID = $oRStcategory->fields["BranchID"];
$oRStcategoryID = $oRStcategory->fields["ID"];
...
$tcategoryCountryID = trim(getValue($oRStcategory->fields["CountryID"]));
endif;
$tcategoryBranchID = "";
if (is_null($oRStcategory->fields["BranchID"])):
$tcategoryBranchID = "";
else:
$tcategoryBranchID = trim(getValue($oRStcategory->fields["BranchID"]));
endif;
$tcategoryID = "";
if (is_null($oRStcategory->fields["ID"])):
$tcategoryID = "";
else:
$tcategoryID = trim(getValue($oRStcategory->fields["ID"]));
endif;
$tcategoryDescription = "";
if (is_null($oRStcategory->fields["Description"])):
$tcategoryDescription = "";
else:
$tcategoryDescription = trim(getValue($oRStcategory->fields["Description"]));
endif;
$DeleteButton = "<form method='post' action='Updatetcategorydel.php' id='form1' name='form1'>";
...
if ($_SESSION["Updatetcategory_EditFailed"] == 1) {
  $tcategoryCountryID = $_SESSION["SavedEdittcategoryCountryID"];
  $tcategoryBranchID = $_SESSION["SavedEdittcategoryBranchID"];
  $tcategoryID = $_SESSION["SavedEdittcategoryID"];
  $tcategoryDescription = $_SESSION["SavedEdittcategoryDescription"];
}
else {
