...
// $RecordsPerPage = ##;
$myRecordCount2 = "SELECT COUNT(*) AS MyCount FROM titems  WHERE titems.CountryID ='".$_SESSION['UserValue1']."' AND titems.BranchID = '".$_SESSION['UserValue2']."' ORDER BY titems.CountryID ASC";
...
$strMyQuote = getQuote($objConn1,"titems", "titems.CountryID");
if ($myWhere != ""):
    $myWhere .= " AND ";
endif;
$myWhere .= "titems.CountryID = " . $strMyQuote . getSession("UserValue1") . $strMyQuote;
$_SESSION["BrowseItems#WHR"] = $myWhere;
$mySQL = $myQuery;
