...
$DeleteButton = "";
$UpdatetunitmeasFormAction = "";
//============================================================================='
// MergeTemplate 
//============================================================================='
function MergeTemplate($Template) {
    if(!isset($Template) || ($Template =="")):
        $Template = "./html/Updatetunitmeas" . "edit.htm";
    endif;
    global $DeleteButton;   
    global $Header;   
    global $Footer;   
...
$UpdatetunitmeasFormAction = "Updatetunitmeaseditx.php";
$oRStunitmeasCountryID = $oRStunitmeas->fields["CountryID"];
$oRStunitmeasBranchID = $oRStunitmeas->fields["BranchID"];
$oRStunitmeasID = $oRStunitmeas->fields["ID"];
...
$tunitmeasCountryID = trim(getValue($oRStunitmeas->fields["CountryID"]));
endif;
$tunitmeasBranchID = "";
if (is_null($oRStunitmeas->fields["BranchID"])):
$tunitmeasBranchID = "";
else:
$tunitmeasBranchID = trim(getValue($oRStunitmeas->fields["BranchID"]));
endif;
$tunitmeasID = "";
if (is_null($oRStunitmeas->fields["ID"])):
$tunitmeasID = "";
else:
$tunitmeasID = trim(getValue($oRStunitmeas->fields["ID"]));
endif;
$tunitmeasDescription = "";
if (is_null($oRStunitmeas->fields["Description"])):
$tunitmeasDescription = "";
else:
$tunitmeasDescription = trim(getValue($oRStunitmeas->fields["Description"]));
endif;
$DeleteButton = "<form method='post' action='Updatetunitmeasdel.php' id='form1' name='form1'>";
...
if ($_SESSION["Updatetunitmeas_EditFailed"] == 1) {
  $tunitmeasCountryID = $_SESSION["SavedEdittunitmeasCountryID"];
  $tunitmeasBranchID = $_SESSION["SavedEdittunitmeasBranchID"];
  $tunitmeasID = $_SESSION["SavedEdittunitmeasID"];
  $tunitmeasDescription = $_SESSION["SavedEdittunitmeasDescription"];
}
else {
