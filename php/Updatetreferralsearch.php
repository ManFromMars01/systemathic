...
if (getRequest("txttreferralCountryID") == ""):
    ...
    $myWhere .= " treferral.CountryID LIKE " . chr(39) . getRequest("txttreferralCountryID") . "%" . chr(39);
endif;
...
if (getRequest("txttreferralBranchID") == ""):
    ...
    $myWhere .= " treferral.BranchID LIKE " . chr(39) . getRequest("txttreferralBranchID") . "%" . chr(39);
endif;
...
if (getRequest("txttreferralID") == ""):
    ...
    $myWhere .= " treferral.ID = " . getRequest("txttreferralID");
endif;

if (getRequest("txttreferralDescription") == ""):
else:
    if ($myWhere == ""):
    else:
       $myWhere .= " AND ";
    endif;
    $myWhere .= " treferral.Description LIKE " . chr(39) . getRequest("txttreferralDescription") . "%" . chr(39);
endif;
...
function MergeSearchTemplate($Template) {
    ...
    if(!isset($Template) || ($Template =="")):
        $Template = "./html/Updatetreferral" . "search.htm";
    endif;
...
$FormDeclaration .=  "Updatetreferral" . "search.php". "\">" . "\n<input type=\"HIDDEN\" id=\"SEARCH\" name=\"SEARCH\" value=\"TRUE\">";
endif;
