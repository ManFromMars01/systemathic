...
if ($myFormAction == "3") {
    ...
    $mySQL = "DELETE FROM tprogress1 WHERE  tprogress1.CountryID = '" . $ID1 . "'" . " AND tprogress1.BranchID = '" . $ID2 . "'" . " AND tprogress1.Level1ID = '" . $ID3 . "'";
...
if (!$myFormAction == "3"):
    ...
    if(getSession("BrowseTProgress1#WHR") != ""):
        $ClarionData .= "<a href=BrowseTProgress1" . "list.php?SUBSET=TRUE>Return to list</a>\n";
    else:
