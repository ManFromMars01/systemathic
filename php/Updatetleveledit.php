...
$DeleteButton = "";
$UpdatetlevelFormAction = "";
//============================================================================='
// MergeTemplate 
//============================================================================='
function MergeTemplate($Template) {
    if(!isset($Template) || ($Template =="")):
        $Template = "./html/Updatetlevel" . "edit.htm";
    endif;
    global $DeleteButton;   
    global $Header;   
    global $Footer;   
...
$UpdatetlevelFormAction = "Updatetleveleditx.php";
$oRStlevelCountryID = $oRStlevel->fields["CountryID"];
$oRStlevelBranchID = $oRStlevel->fields["BranchID"];
$oRStlevelID = $oRStlevel->fields["ID"];
...
$tlevelCountryID = trim(getValue($oRStlevel->fields["CountryID"]));
endif;
$tlevelBranchID = "";
if (is_null($oRStlevel->fields["BranchID"])):
$tlevelBranchID = "";
else:
$tlevelBranchID = trim(getValue($oRStlevel->fields["BranchID"]));
endif;
$tlevelID = "";
...
if ($_SESSION["Updatetlevel_EditFailed"] == 1) {
  $tlevelCountryID = $_SESSION["SavedEdittlevelCountryID"];
  $tlevelBranchID = $_SESSION["SavedEdittlevelBranchID"];
  $tlevelID = $_SESSION["SavedEdittlevelID"];
  $tlevelDescription = $_SESSION["SavedEdittlevelDescription"];
}
else {
  $_SESSION["Updatetlevel_EditFailed"] = 0;
}
