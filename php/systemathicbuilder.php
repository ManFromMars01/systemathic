...
$TemplateText = Replace($TemplateText, "@UserID@", $_SESSION("UserID"));
$TemplateText = Replace($TemplateText, "@UserEmail@", $_SESSION("UserEmail"));
$TemplateText = Replace($TemplateText, "@UserName@", $_SESSION("UserName"));
