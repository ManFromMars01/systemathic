...
if ($myFormAction == "3") {
    ...
    $mySQL = "DELETE FROM tlevel WHERE  tlevel.CountryID = '" . $ID1 . "'" . " AND tlevel.BranchID = '" . $ID2 . "'" . " AND tlevel.ID = " . $ID3;
...
if (!$myFormAction == "3"):
    ...
    if(getSession("BrowseLevel#WHR") != ""):
        $ClarionData .= "<a href=BrowseLevel" . "list.php?SUBSET=TRUE>Return to list</a>\n";
    else:
