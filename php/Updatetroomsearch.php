...
if (getRequest("txttroomCountryID") == ""):
    ...
    $myWhere .= " troom.CountryID LIKE " . chr(39) . getRequest("txttroomCountryID") . "%" . chr(39);
endif;
...
if (getRequest("txttroomBranchID") == ""):
    ...
    $myWhere .= " troom.BranchID LIKE " . chr(39) . getRequest("txttroomBranchID") . "%" . chr(39);
endif;
...
if (getRequest("txttroomID") == ""):
    ...
    $myWhere .= " troom.ID = " . getRequest("txttroomID");
endif;

if (getRequest("txttroomDescription") == ""):
else:
    if ($myWhere == ""):
    else:
       $myWhere .= " AND ";
    endif;
    $myWhere .= " troom.Description LIKE " . chr(39) . getRequest("txttroomDescription") . "%" . chr(39);
endif;

if (getRequest("txttroomTotalSeat") == ""):
else:
    if ($myWhere == ""):
    else:
       $myWhere .= " AND ";
    endif;
    $myWhere .= " troom.TotalSeat = " . getRequest("txttroomTotalSeat");
endif;
...
function MergeSearchTemplate($Template) {
    ...
    if(!isset($Template) || ($Template =="")):
        $Template = "./html/Updatetroom" . "search.htm";
    endif;
...
$DisplayText = "";
if (getRequest("SEARCH") == "TRUE"):
$FormDeclaration = "<form name=\"form1\" id=\"form1\" method=\"POST\" action=\"BrowseRoomlist.php\">";
else:
$FormDeclaration = "<form name=\"form1\" id=\"form1\" method=\"POST\" action=\""; 
$FormDeclaration .=  "Updatetroom" . "search.php". "\">" . "\n<input type=\"HIDDEN\" id=\"SEARCH\" name=\"SEARCH\" value=\"TRUE\">";
endif;
