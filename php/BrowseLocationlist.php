...
// $RecordsPerPage = ##;
$myRecordCount2 = "SELECT COUNT(*) AS MyCount FROM tlocation  WHERE tlocation.CountryID ='".$_SESSION['UserValue1']."' AND tlocation.BranchID = '".$_SESSION['UserValue2']."' ORDER BY tlocation.CountryID ASC";
...
$strMyQuote = getQuote($objConn1,"tlocation", "tlocation.CountryID");
if ($myWhere != ""):
    $myWhere .= " AND ";
endif;
$myWhere .= "tlocation.CountryID = " . $strMyQuote . getSession("UserValue1") . $strMyQuote;
$_SESSION["BrowseLocation#WHR"] = $myWhere;
$mySQL = $myQuery;
