...
$DeleteButton = "";
$UpdatettierFormAction = "";
//============================================================================='
// MergeTemplate 
//============================================================================='
function MergeTemplate($Template) {
    if(!isset($Template) || ($Template =="")):
        $Template = "./html/Updatettier" . "edit.htm";
    endif;
    global $DeleteButton;   
    global $Header;   
    global $Footer;   
...
$UpdatettierFormAction = "Updatettiereditx.php";
$oRSttierCountryID = $oRSttier->fields["CountryID"];
$oRSttierBranchID = $oRSttier->fields["BranchID"];
$oRSttierID = $oRSttier->fields["ID"];
...
$ttierCountryID = trim(getValue($oRSttier->fields["CountryID"]));
endif;
$ttierBranchID = "";
if (is_null($oRSttier->fields["BranchID"])):
$ttierBranchID = "";
else:
$ttierBranchID = trim(getValue($oRSttier->fields["BranchID"]));
endif;
$ttierID = "";
...
$ttierDescription = trim(getValue($oRSttier->fields["Description"]));
endif;
$DeleteButton = "<form method='post' action='Updatettierdel.php' id='form1' name='form1'>";
...
if ($_SESSION["Updatettier_EditFailed"] == 1) {
  $ttierCountryID = $_SESSION["SavedEditttierCountryID"];
  $ttierBranchID = $_SESSION["SavedEditttierBranchID"];
  $ttierID = $_SESSION["SavedEditttierID"];
  $ttierDescription = $_SESSION["SavedEditttierDescription"];
}
else {
